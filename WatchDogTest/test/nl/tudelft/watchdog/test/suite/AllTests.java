...
import nl.tudelft.watchdog.test.interval.ActiveEditingIntervalTest;
...
@RunWith(Suite.class)
@SuiteClasses({ActiveEditingIntervalTest.class, IntervalsToXMLWriterTest.class, DocumentClassifierTest.class, DocumentFactoryTest.class})
