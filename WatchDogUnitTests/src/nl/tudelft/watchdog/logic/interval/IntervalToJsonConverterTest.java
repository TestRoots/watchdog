...
public class IntervalToJsonConverterTest {
	...
	public void testJsonReadingIntervalRepresentation() {
		...
		assertEquals(
				"[{\"doc\":{\"pn\":\"f6f4da8d93e88a08220e03b7810451d3ba540a34\",\"fn\":\"90a8834de76326869f3e703cd6151.0.2ad73d3c\",\"sloc\":1,\"dt\":\"pr\"},\"it\":\"re\",\"ts\":1,\"te\":2,\"ss\":0,\"uid\":\"123\",\"wdv\":\""
	...
	public void testJsonTypingIntervalMissingDocumentRepresentation() {
		...
		JsonTransferer intervalTransferer = new JsonTransferer();
		assertEquals(
				"[{\"doc\":{\"pn\":\"f6f4da8d93e88a08220e03b7810451d3ba540a34\",\"fn\":\"90a8834de76326869f3e703cd6151.0.2ad73d3c\",\"sloc\":1,\"dt\":\"pr\"},\"it\":\"ty\",\"ts\":1,\"te\":2,\"ss\":0,\"uid\":\"123\",\"wdv\":\""
						+ WatchDogGlobals.CLIENT_VERSION + "\"}]",
				intervalTransferer.toJson(intervals));
	}
	...
	public void testJsonTypingIntervalTwoSameIntervalsRepresentation() {
		...
		JsonTransferer intervalTransferer = new JsonTransferer();
		assertEquals(
				"[{\"endingDocument\":{\"pn\":\"f6f4da8d93e88a08220e03b7810451d3ba540a34\",\"fn\":\"90a8834de76326869f3e703cd6151.0.2ad73d3c\",\"sloc\":1,\"dt\":\"pr\"},\"diff\":0,\"doc\":{\"pn\":\"f6f4da8d93e88a08220e03b7810451d3ba540a34\",\"fn\":\"90a8834de76326869f3e703cd6151.0.2ad73d3c\",\"sloc\":1,\"dt\":\"pr\"},\"it\":\"ty\",\"ts\":1,\"te\":2,\"ss\":0,\"uid\":\"123\",\"wdv\":\""
						+ WatchDogGlobals.CLIENT_VERSION + "\"}]",
				intervalTransferer.toJson(intervals));
	}
