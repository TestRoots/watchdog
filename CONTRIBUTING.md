...
- `watchdog` ...
- ...
- `watchdog.server` is the Ruby server project. We managed it via Maven to have included in the CI build, but ideally, you modify its relatively short code in a Ruby IDE.
