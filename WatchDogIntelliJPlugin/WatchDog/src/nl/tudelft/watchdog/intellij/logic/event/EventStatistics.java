...
public class EventStatistics extends EventStatisticsBase {
    ...
    public GanttCategoryDataset createDebugEventGanttChartDataset() {
        ...
        allTasks.add(createTaskForEventsWithName(bpRemoveEvents, "Breakpoint Removed"
        ));
        allTasks.add(createTaskForEventsWithName(suspendBpEvents, "Suspended (breakpoint)"
        ));
        allTasks.add(createTaskForEventsWithName(suspendClientEvents, "Suspended (client)"
        ));
        ...
        allTasks.add(createTaskForEventsWithName(resumeClientEvents, "Resumed (client)"
        ));
        allTasks.add(createTaskForEventsWithName(inspectEvents, "Inspected Variable"
        ));
        allTasks.add(createTaskForEventsWithName(defineWatchEvents, "Defined Watch"
        ));
        allTasks.add(createTaskForEventsWithName(evalExpressionEvents, "Evaluated Expression"
        ));
        allTasks.add(createTaskForEventsWithName(modVarValueEvents, "Modified Variable Value"
        ));
