...
public class WatchDogLogger {
	...
	private File logDirectory = new File(PluginManager.getPlugin(PluginId.findId("nl.tudelft.watchdog")).getPath().toString() + "/logs/");
	...
	private WatchDogLogger() {
		try {
			...
			// IntelliJ is not running. In this case, always set up the logger.
		}
		...
		try {
			...
			FileHandler fileHandler = new FileHandler(
					logDirectory + "/watchdoglog.log", true);
